...
public class Operation extends AbstractStep {
    ...
    public void setType(String type) {
        ...
        if ("UPDATE".equals(type)) {
            ...
            _operation = org.dbunit.ext.mysql.InsertIdentityOperation.CLEAN_INSERT;
            _forwardOperation = false;
        } else if ("MSSQL_INSERT".equals(type)) {
            _operation = org.dbunit.ext.mysql.InsertIdentityOperation.INSERT;
            _forwardOperation = true;
        } else if ("MSSQL_REFRESH".equals(type)) {
            _operation = org.dbunit.ext.mysql.InsertIdentityOperation.REFRESH;
            _forwardOperation = true;
        } else {

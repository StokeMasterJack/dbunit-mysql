...
public abstract class AbstractDatabaseTester extends SimpleAssert implements IDatabaseTester
{
    ...
    public void onSetup() throws Exception
    {
        ...
        org.dbunit.operation.DatabaseOperation setUpOperation1 = getSetUpOperation();
        executeOperation(setUpOperation1, OperationType.SET_UP);
    }
    ...
    private void executeOperation(DatabaseOperation operation, OperationType type) throws Exception
    {
        ...
        if (operation != DatabaseOperation.NONE)
        {
            ...
            try
            {
                org.dbunit.dataset.IDataSet dataSet1 = getDataSet();
                operation.execute(connection, dataSet1);
            } finally
            {

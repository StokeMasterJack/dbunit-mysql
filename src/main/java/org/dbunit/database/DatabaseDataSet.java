...
public class DatabaseDataSet extends AbstractDataSet
{
    ...
    private SchemaSet _schemaSet = new SchemaSet();
    ...
    public DatabaseDataSet(IDatabaseConnection connection) throws SQLException
    {
        this(connection, null);
    }


    public DatabaseDataSet(IDatabaseConnection connection, ITableFilterSimple tableFilter)
    throws SQLException
    {
        super();
        if (connection == null) {
    ...
    throws DataSetException
    {
        ...
        for (int i = 0; i < columns.length; i++)
        {
            ...
            String columnName1 = columns[i].getColumnName();
            org.dbunit.util.QualifiedTableName qualifiedTableName = new org.dbunit.util.QualifiedTableName(columnName1, null, escapePattern);
            String columnNameQ = qualifiedTableName.getQualifiedName();
            sqlBuffer.append(columnNameQ);
        }
  ...
  private String getDefaultSchema() {
    ...
    public ITableMetaData getTableMetaData(String tableName) throws DataSetException
    {
        ...
        initialize(qualifiedTableName.getDatabase());
        ...
        metaData = new DatabaseTableMetaData(tableName, _connection, true);

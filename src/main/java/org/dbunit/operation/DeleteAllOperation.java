...
public class DeleteAllOperation extends AbstractOperation
{
    ...
    public void execute(IDatabaseConnection connection, IDataSet dataSet) throws DatabaseUnitException, SQLException{
        ...
        try
        {
            ...
            while (iterator.next())
            {
                org.dbunit.dataset.ITableMetaData tableMetaData = iterator.getTableMetaData();
            ...
            while (!tableNames.isEmpty())
            {
                ...
                sqlBuffer.append(getQualifiedName(connection.getDatabase(), tableName, connection));
